	...
	public SecurityFilterChain authorizeRequests(HttpSecurity http) throws Exception {
		...
		http.csrf(customizer -> customizer.disable())
				...
				.authorizeHttpRequests(request -> request.requestMatchers("/Login",
						...
						"/childhome/allChildhomedetails", "contactus","/childhome/childhomecount","/childhome/employeecount","/api/create-order","/api/verify-payment","/childhome/allEventsDetails").permitAll()
